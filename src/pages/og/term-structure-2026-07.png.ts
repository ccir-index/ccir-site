...
// OG card for ccir.io/term — v2 path (2026-07): minted to bust X/LinkedIn scraper caches after the terminal restyle. Keep in lockstep with term-structure.png.ts or retire the old path next cycle.
const SPEC = {
