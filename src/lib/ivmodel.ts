...
export const ivCards = IV_SPEC.map((s) => {
  ...
  // life is HELD at the 6-year base, disclosed as held (John, 2026-08-25).
  // Life legs were tried twice and rejected: folded into the min–max, a
  // ±1y leg on the aged A100 made the band read 90% of base; broken out as
  // labeled scenario marks, the 7y leg printed a ~$14.7k A100 value John
  // ruled not defensible as a published figure. Do not reintroduce either
  // form without a new ruling.
